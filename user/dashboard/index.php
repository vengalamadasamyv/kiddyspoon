...
<div class="dashboard">
  ...
  <main class="content">
    ...
    <h3 class="bs">Our Products</h3>

    <div class="product">
        <section>
            <div class="prod">
                <img src="../../asset/dash-pro.png" class="product-img">
                <section>
                    <p style="font-weight:500; font-size:20px; margin-bottom:10px;">Sprouted Ragi Porridge</p>
                    <p style="margin-bottom:10px; font-size:24px; font-weight:700;"><strike style="font-size:12px; font-weight:100;">Rs.449/-</strike>&nbsp;&nbsp;Rs.299/-&nbsp;&nbsp;<span style="font-size:12px; border-radius:30px; background:#fff; color:black; padding:3px;">Save Rs.150</span></p>
                    <div class="qty-box">
        ...
        <section>
            <div class="prod">
                <img src="../../asset/dash-pro.png" class="product-img">
                <section>
                    <p style="font-weight:500; font-size:20px; margin-bottom:10px;">Millet Grains Nutri Mix</p>
                    <p style="margin-bottom:10px; font-size:24px; font-weight:700;"><strike style="font-size:12px; font-weight:100;">Rs.449/-</strike>&nbsp;&nbsp;Rs.299/-&nbsp;&nbsp;<span style="font-size:12px; border-radius:30px; background:#fff; color:black; padding:3px;">Save Rs.150</span></p>
                    <div class="qty-box">
                        <button class="qty-btn minus">−</button>
                        <input type="number" class="qty-input" value="1" min="1" readonly>
